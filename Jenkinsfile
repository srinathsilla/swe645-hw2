   ...
   stages {
         ...
         steps {
            ...
            script{
               ...
               docker.withRegistry('',registryCredential){
                  def customImage = docker.build("srinathsilla/student-survey-form:${env.BUILD_NUMBER}-loadbalancer")
               }
            }
         }
      }
      ...
      stage('Push Image to Dockerhub') {
         steps {
            ...
            script{
               docker.withRegistry('',registryCredential){
                  sh "docker push srinathsilla/student-survey-form:${env.BUILD_NUMBER}-loadbalancer"
               }
            }
         }
      }
